...
const API =
  "http://localhost/ProgressMonitoringProject/api";

export default function FinalTaskAllocation() {
  ...
  const fetchGroup = async () => {
    try {
      ...
      const res = await axios.get(
        `${API}/fyp2-scores/groups/${groupId}`
      );
  ...
  const openStudentProgress = (studentId) => {
    ...
    setLocation(
      `/student-progress/${studentId}/FYP-2`
    );
  };
        ...
        <div className="border rounded-2xl p-5 bg-white shadow-sm space-y-5">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 bg-blue-50/50 border border-blue-100 p-4 rounded-xl">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs font-bold uppercase text-blue-600 tracking-wider">Assigned Project</span>
                </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Write final task here..."
              className="
                w-full
                border
                rounded-xl
